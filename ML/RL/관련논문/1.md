...
- 여러 가지 경로 계획 알고리즘
  ...
  | 알고리즘 | 특징 | 적용 환경 | 장점 | 단점 | 사용예|
  |:-|:-|:-|:-|:-|:-|
  |Dijkstra(D<sup>*</sup>)|최단 경로 보장<br>환경 변화에 빠르게 적응|정적 환경<br>동적 환경|정확한 경로 계산<br>동적 환경에서는 실시간 경로 수정 가능|계산량 많음<br>구현 복잡|동적 환경의 Planetary rovers|
  |A star(A<sup>*</sup>)|Heuristics 사용으로 빠른 계산|정적 환경|계산 효율 높음|휴리스틱에 따라 성능 변동||
  |RRTs<br>(Rapidly exploring Random Trees)|트리 구조로 경로 탐색|동적 환경|복잡한 공간에 적합|최적 경로 보장 어려움||
